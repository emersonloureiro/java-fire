...
public interface EventTransaction {
	 ...
	 * any of the synchronous events will automatically cause this transaction
	 * to rollback, and a {@link TransactionException} to be thrown. See
	 * {@link EventTransaction#rollback()}.
	 * 
	 * @throws EventException If there's any error processing/dispatching the
	 *             events for this transaction, including errors within the
	 *             handlers for each event.
	 * @throws TransactionException If there's any other error when committing
	 *             the transaction
	 */
